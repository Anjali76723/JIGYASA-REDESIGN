export const servicesData = [
  {
    slug: 'graphics-web-designing',
    title: 'Graphics & Web Designing',
    tagline: 'Premium Vector Blueprints, Brand Identity, and High-Fidelity Graphics Assets',
    ...
    tags: ['Figma', 'Photoshop', 'Illustrator', 'Spline 3D'],
    keyDeliverables: [
      'Logo suites & brand guidelines',
      'Social, ads & campaign assets',
      'Design handoff for dev teams'
    ],
    features: [
      { title: 'Brand Guidelines blueprint', desc: 'Detailed grids defining typography, color codes, logo variants, and layouts.' },
  ...
  },
  {
    ...
    tags: ['Figma', 'Framer', 'CSS Grid', 'Adobe XD'],
    keyDeliverables: [
      'User journeys & information architecture',
      'High-fidelity UI in your brand',
      'Developer-ready specs & components'
    ],
    features: [
  ...
  },
  {
    ...
    keyDeliverables: [
      'Responsive builds & component libraries',
      'CRM/payment integrations',
      'CI/CD & staging workflows'
    ],
    features: [
  ...
  },
  {
    ...
    tags: ['React Native', 'Swift', 'Kotlin', 'Firebase', 'SQLite'],
    keyDeliverables: [
      'Product roadmaps & MVP scopes',
      'Secure auth & data sync',
      'Beta, QA & store submissions'
    ],
    features: [
  ...
  },
  {
    ...
    tags: ['C#', 'Go', 'Java', 'Python', 'PostgreSQL', 'Redis'],
    keyDeliverables: [
      'Domain modeling',
  ...
  },
  {
    ...
    tagline: 'High-Converting Checkout Storefronts, Cart blueprints, and Stripe Portals',
    ...
    tags: ['Shopify API', 'Stripe SDK', 'Next.js', 'Redux'],
    keyDeliverables: [
      'Cart/tax/shipping',
      'Payment gateways',
      'ERP sync'
  ...
  },
  {
    ...
    tags: ['Sanity.io', 'Strapi', 'WordPress', 'GraphQL', 'PHP'],
    keyDeliverables: [
      'Custom themes',
      'Structured content',
      'Migration & caching'
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80',
    tags: ['Google Ads', 'Meta Manager', 'GA4', 'HubSpot'],
    keyDeliverables: [
      'Media planning',
      'Landing pages',
